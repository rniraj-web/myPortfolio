...
export const ABOUT_TEXT = `I am a dedicated software engineer with a love for designing effective and user-friendly web applications. I have experience as an Analyst (Software Developer) at Merkle, where I focused on frontend development, while also obtaining hands-on knowledge with React, Node.js, and JavaScript while working on several projects.  Motivated to constant learning, as I am now learning Next.js to better my full-stack development skills. I thrive in collaborative workplaces and enjoy solving complex problems. Beyond programming, I have represented India at the World Pencak Silat Championship and the Asian Championship. `;
